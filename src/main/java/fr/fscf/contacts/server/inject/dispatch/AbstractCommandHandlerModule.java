package fr.fscf.contacts.server.inject.dispatch;
...
/**
 * <p>
 * This is an abstract base class that configures Guice to inject {@link Dispatch} and
 * {@link CommandHandler} instances.<br>
 * If no other prior instance of {@link DispatchModule} has been installed, the standard {@link
 * Dispatch} and {@link CommandHandlerRegistry} classes will
 * be configured.
 * </p>
 * <p>
