package fr.fscf.contacts.server.config.persistence;

import fr.fscf.contacts.server.config.ConfigUtils;
import fr.fscf.contacts.server.config.persistence.provider.CloudUnit;
import fr.fscf.contacts.server.config.persistence.provider.Heroku;
import fr.fscf.contacts.server.config.persistence.provider.PersistenceConfigurationProvider;
