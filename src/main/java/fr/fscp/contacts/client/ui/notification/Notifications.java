...
import fr.fscp.contacts.client.ui.widget.popup.AbstractPopupWidget;
import fr.fscp.contacts.client.ui.widget.popup.NotificationWidget;
...
final class Notifications {
    ...
    public static void show(final String title, final String html, MessageType type) {
        ...
        // Shows it.
        notificationWidget.getPopup().setPopupPositionAndShow(new fr.fscp.contacts.client.ui.widget.panel.PopupPanel.PositionCallback() {
