...
import fr.fscp.contacts.client.AppEntryPoint;
import fr.fscp.contacts.client.config.Injector;
import fr.fscp.contacts.client.event.bus.EventBus;
import fr.fscp.contacts.client.event.page.PageChangedEvent;
import fr.fscp.contacts.client.event.page.PageRequestEvent;
import fr.fscp.contacts.client.event.page.PageRequestHandler;
