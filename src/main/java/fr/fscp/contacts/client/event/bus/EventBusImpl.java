package fr.fscp.contacts.client.event.bus;
...
import fr.fscp.contacts.client.dispatch.CommandResultHandler;
import fr.fscp.contacts.client.event.page.PageRequestEvent;
import fr.fscp.contacts.client.event.zone.ZoneRequestEvent;
import fr.fscp.contacts.client.i18n.I18N;
import fr.fscp.contacts.client.ui.notification.N10N;
import fr.fscp.contacts.client.navigation.*;
import fr.fscp.contacts.client.ui.presenter.base.Presenter;
