package fr.fscp.contacts.client.navigation;

import fr.fscp.contacts.client.event.page.PageParsingException;
import fr.fscp.contacts.shared.util.ClientUtils;
import fr.fscp.contacts.shared.util.Pair;
...
public final class PageRequest {
    ...
    public PageRequest addAllParameters(final Map<RequestParameter, ?> parameters) {
        ...
        for (final Map.Entry<RequestParameter, ?> parameter : parameters.entrySet()) {
     ...
     *         If the given {@code token} is invalid.
     */
    static PageRequest fromString(final String token, final Map<String, Pair<Page, Boolean>> pages,
                                  final Map<RequestParameter, Object> dataParameters) throws PageParsingException {
        ...
        if (req != null && dataParameters != null) {
            for (final Map.Entry<RequestParameter, Object> dataParameter : dataParameters.entrySet()) {
    ...
    public static String toUrl(final String pageToken, final Map<RequestParameter, String> parameters) {
        ...
        if (ClientUtils.isNotEmpty(parameters)) {
            for (final Map.Entry<RequestParameter, String> param : parameters.entrySet()) {
