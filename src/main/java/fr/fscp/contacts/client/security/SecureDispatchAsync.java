...
/**
 * This class is the default implementation of {@link Dispatch}, which is essentially the
 * client-side access
 * to the {@link Dispatch} class on the server-side.
 *
 * @author Denis
 */
