...
import fr.fscp.contacts.shared.Language;
...
public class AuthenticationProvider implements Provider<Authentication> {
    ...
    public Authentication get() {
        ...
        if (isAnonymous()) {
            ...
            final String token = Cookies.getCookie(fr.fscp.contacts.shared.util.Cookies.AUTH_TOKEN_COOKIE);
    ...
    public void login(final Authentication authentication) {
        ...
        // Cookies properties.
        final String path = fr.fscp.contacts.shared.util.Cookies.COOKIE_PATH;
        final String domain = fr.fscp.contacts.shared.util.Cookies.COOKIE_DOMAIN;
        final boolean secure = fr.fscp.contacts.shared.util.Cookies.COOKIE_SECURED;

        // Sets the cookies.
        Cookies.setCookie(fr.fscp.contacts.shared.util.Cookies.AUTH_TOKEN_COOKIE, authentication.getAuthenticationToken(), oneDayLater(), domain, path, secure);
        Cookies.setCookie(fr.fscp.contacts.shared.util.Cookies.LANGUAGE_COOKIE, authentication.getLanguage().getLocale(), oneDayLater(), domain, path, secure);
    ...
    public void updateCache(final Authentication authentication) {
        ...
        // Caches the authentication data.
        authentication.setAuthenticationToken(Cookies.getCookie(fr.fscp.contacts.shared.util.Cookies.AUTH_TOKEN_COOKIE));
        this.authentication = authentication;
    }
    ...
    public boolean clearAuthentication() {
        ...
        Cookies.removeCookie(fr.fscp.contacts.shared.util.Cookies.AUTH_TOKEN_COOKIE, fr.fscp.contacts.shared.util.Cookies.COOKIE_PATH);
    ...
    public boolean isAnonymous() {
        ...
        final boolean anonymous = ClientUtils.isBlank(Cookies.getCookie(fr.fscp.contacts.shared.util.Cookies.AUTH_TOKEN_COOKIE));
