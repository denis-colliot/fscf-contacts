package fr.fscp.contacts.server.config.persistence;

import fr.fscp.contacts.server.config.ConfigUtils;
import fr.fscp.contacts.server.config.persistence.provider.CloudUnit;
import fr.fscp.contacts.server.config.persistence.provider.Heroku;
import fr.fscp.contacts.server.config.persistence.provider.PersistenceConfigurationProvider;
